    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-50">
			...
			<form action="payments/PaytmKit/pgRedirect.php" method="post">
            <label for="fname"><i class="fa fa-user"></i> Full Name</label>
            <input type="text" id="fname" name="firstname" placeholder="A.B.C" required>
